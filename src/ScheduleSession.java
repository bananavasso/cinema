        ...
        btnSchedule.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try{
                    ...
                    scheduledMovie.setTitle( (String) comboBox.getSelectedItem());
                    scheduledMovie.setDate(tfScheduleDate.getText());
                    scheduledMovie.setTime(tfScheduleTime.getText());

                    JOptionPane.showMessageDialog(null, "cinema.Movie Scheduled Successfully");
