        ...
        btnRegister.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    newMovie.setTitle(tfMovieTitle.getText());
                    newMovie.setCast(tfBilledCast.getText());
                    newMovie.setDirector(tfDirector.getText());
                    newMovie.setReleaseDate(tfReleaseDate.getText());
                    newMovie.setDuration(tfDuration.getText());
                    newMovie.setGenre(tfGenre.getText());
                    newMovie.setRating(tfRating.getText());
                    newMovie.setDistributor(tfDistributor.getText());
                    newMovie.setWebsite(tfWebsite.getText());
                    newMovie.setSynopsis(taSynopsis.getText());
